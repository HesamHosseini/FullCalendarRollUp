...
const dataArr = [];
  for (let index = 0; index <2; index++) {
    ...
    switch (index) {
      case index:        dataArr.push(prompt("enter you task date : ", Date.now()));
        break;
      case index:        dataArr.push(prompt("task title : ", "تتیر تسک خود را وارد کنید"));
        break;
      case index:        dataArr.push(prompt("ایا کل روز من را اشغال میکند ؟ : ", true));
        break;
    }
